Feature: Get balance civic card
  ...
  Scenario Outline: Consult all services when Content-Type header is empty
    ...
    * configure headers = genericHeader
    ...
    Examples:
      | path                           | data                                                 |
      | recharges/balance              | ../balance/datajson/balanceRequest.json              |
      | recharge/categoriesandservices | ../categoryandservice/datajson/categoryAndServiceRequest.json  |
      | recharge/details               | ../details/datajson/detailsRequest.json               |
      | /recharges/recharge          | ../recharge/datajson/rechargeRequest.json |
  ...
  Scenario Outline: Consult all services when Content-Type header is empty
    ...
    * configure headers = genericHeader
    ...
    When method POST
    Then status 200
    And match response.errors[0].status == "415"

    Examples:
      | path                           | data                                                 |
      | recharge/costrecharge          | ../costrecharge/datajson/costRechargeRequest.json |
